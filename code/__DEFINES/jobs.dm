...
#define F13ECOMMANDER	(1<<0)
#define F13EATROOPER	(1<<1)
#define F13ETROOPER	    (1<<2)
#define F13ESCIENTIST	(1<<3)
...
#define JOB_DISPLAY_ORDER_EOFFICER 119
#define JOB_DISPLAY_ORDER_EATROOPER 120 
#define JOB_DISPLAY_ORDER_ETROOPER 121 
#define JOB_DISPLAY_ORDER_ESCIENTIST 122 
