...
#define REAGENT_VALUE_VERY_COMMON	0.01 //same as above, just not so unlimited.
#define REAGENT_VALUE_COMMON		0.05
#define REAGENT_VALUE_UNCOMMON		0.1
#define REAGENT_VALUE_RARE			0.25
#define REAGENT_VALUE_VERY_RARE		0.5
#define REAGENT_VALUE_EXCEPTIONAL	1	//extremely rare or tedious to craft, possibly unsynthetizable, reagents.
#define REAGENT_VALUE_AMAZING		3	//reserved ONLY for non-mass produceable, unsynthetizable reagents.
#define REAGENT_VALUE_GLORIOUS		30	//reagents that shouldn't be possible to get or farm under normal conditions. e.g. Romerol, fungal TB, adminordrazine...
