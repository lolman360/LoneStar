...
/datum/job/ncr/f13trooper
	...
	loadout_options = list(
		...
		/datum/outfit/loadout/trooperfiresupport, // Hunting Rifle
		/datum/outfit/loadout/troopershotgun, // Hunting shotgun, Trench tool
		)
...
/datum/outfit/loadout/troopershotgun
	name = "Reservist"
