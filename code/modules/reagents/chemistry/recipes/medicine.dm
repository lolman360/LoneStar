...
/datum/chemical_reaction/stimpak2
	...
	required_reagents = list(/datum/reagent/consumable/brocjuice = 3, /datum/reagent/consumable/xanderjuice = 3, /datum/reagent/blood = 1)
	OptimalTempMin 		= 500 // Lower area of bell curve for determining heat based rate reactions
...
/datum/chemical_reaction/superstimpak
	...
	required_reagents = list(/datum/reagent/blood/synthetics = 1, /datum/reagent/drug/aranesp = 1, /datum/reagent/medicine/stimpak = 1, /datum/reagent/consumable/mutjuice = 1, /datum/reagent/medicine/salglu_solution = 1, /datum/reagent/medicine/pen_acid/pen_jelly = 1, /datum/reagent/medicine/regen_jelly = 1, /datum/reagent/medicine/clonexadone = 0.1)
	OptimalTempMin 		= 45
	OptimalTempMax		= 80
	ExplodeTemp			= 85
	OptimalpHMin		= 1
